    ...
    return (
        <section class="text-gray-700 body-font relative">
            <div class="absolute inset-0 bg-gray-300">
                <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title="map" scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=Toko+Nusantara+Waringin+Agrabinta&ie=UTF8&t=&z=14&iwloc=B&output=embed"></iframe>
            </div>
            <div class="container px-5 py-16 mx-auto flex">
                ...
                <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
                    ...
                    <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Button</button>
                    {/* <button class="text-white bg-indigo-500 border-0 py-2 px-6 rounded text-lg">Button</button> */}
